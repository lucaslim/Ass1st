...
<div id="contentBegin" class="container-fluid">
	...
	<div class="row-fluid">
		...
		<div id="rightContent" class="span8">
			...
			<p style="text-indent: 45px">Developed by Team Assist, this essential website is asset to any well-established sports leagues and all up and coming ones. Designed with the intentions of reusability, strengthened by unique and dynamic features, allowing for daily interactions; the Assist website is expected to an instant hit. Assist is constructed by athletes of athletes of any skill level and is expected launched date of early May 2013.</p>
		</div>
	</div>
	<hr>
	<div class="row-fluid">
		<div class="span2">
			<img src="<?= base_url()?>/uploads/assistlogo/mike.jpg" alt="Team Assist" title="Team Assist" />
		</div>
		<div class="span10">
	...
	<div class="row-fluid">
		<div class="span2">
			<img src="<?= base_url()?>/uploads/assistlogo/lucas.jpg" alt="Team Assist" title="Team Assist" />
		</div>
		<div class="span10">
	...
	<div class="row-fluid">
		<div class="span2">
			<img src="<?= base_url()?>/uploads/assistlogo/neil.jpg" alt="Team Assist" title="Team Assist" />
		</div>
		<div class="span10">
	...
	<div class="row-fluid">
		<div class="span2">
			<img src="<?= base_url()?>/uploads/assistlogo/joel.jpg" alt="Team Assist" title="Team Assist" />
		</div>
		<div class="span10">
